...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="backdrop-blur-xl bg-black/40 border border-orange-500/20 rounded-full shadow-xl px-4 sm:px-6 md:px-8 py-3 sm:py-4 max-w-6xl mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <NavLink 
              to="/contact" 
              className="px-6 py-2.5 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full font-semibold text-white shadow-lg hover:shadow-orange-500/50 hover:scale-105 transition-all text-sm"
            >
              Get Started
            </NavLink>
          </div>
          ...
          <button 
            ...
            className="md:hidden w-10 h-10 rounded-full bg-orange-500/20 hover:bg-orange-500/30 flex items-center justify-center transition-all"
      ...
      {mobileMenuOpen && (
        <motion.div 
          ...
          exit={{ opacity: 0, y: -10 }}
          className="md:hidden backdrop-blur-xl bg-black/40 border border-orange-500/20 rounded-2xl overflow-hidden mt-2 shadow-xl max-w-6xl mx-auto"
        >
          <div className="px-3 py-3 flex flex-col gap-1.5">
            ...
            <NavLink 
              ...
              to="/contact" 
              className="mt-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full font-semibold text-white text-center shadow-lg"
            >
              Get Started
            </NavLink>
          </div>
